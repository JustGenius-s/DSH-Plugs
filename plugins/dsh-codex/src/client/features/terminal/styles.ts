...
.dsh-warp-terminal-banner{display:flex;align-items:center;gap:10px;min-height:30px;padding:6px 10px;margin:0 0 8px;border:1px solid rgba(207,34,46,.35);border-radius:8px;background:rgba(207,34,46,.08);font-size:13px;color:var(--dsw-alias-label-primary,#1f2328)}
.dsh-warp-terminal-banner.is-reconnecting{border-color:rgba(154,103,0,.35);background:rgba(154,103,0,.08)}
.dsh-warp-terminal-error{color:#cf222e;font-size:13px}
.dsh-warp-terminal-reconnecting{color:#9a6700;font-size:13px}
...
.dsh-warp-seg-version{color:#1a7f37}
.dsh-warp-seg-cwd{color:#0550ae}
.dsh-warp-seg-branch{color:#8250df}
.dsh-warp-seg-files{color:#9a6700}
.dsh-warp-seg-adds{color:#1a7f37}
.dsh-warp-seg-dels{color:#cf222e}
.dsh-warp-seg-duration{color:var(--dsw-alias-label-tertiary,#8b8b90)}
.dsh-warp-terminal-iconbtn{width:24px;height:24px;display:inline-flex;align-items:center;justify-content:center;border:none;border-radius:6px;font-size:13px;line-height:1;cursor:pointer;color:var(--dsw-alias-label-secondary,#57606a);background:transparent}
.dsh-warp-terminal-iconbtn:hover{background:rgba(0,0,0,.06);color:var(--dsw-alias-label-primary,#1f2328)}
.dsh-warp-terminal-iconbtn-kill{color:#cf222e}
.dsh-warp-terminal-iconbtn-kill:hover{background:rgba(207,34,46,.12);color:#a40e26}
...
.dsh-warp-terminal-completion-menu{position:absolute;z-index:40;left:0;top:100%;min-width:220px;max-width:min(440px,100%);max-height:192px;overflow:auto;padding:4px;border:1px solid rgba(0,0,0,.12);border-radius:6px;background:var(--dsw-alias-bg-base,#ffffff);box-shadow:0 8px 24px rgba(0,0,0,.18)}
.dsh-warp-terminal-completion-menu-up{top:auto;bottom:100%}
.dsh-warp-terminal-completion-option{display:flex;width:100%;align-items:center;justify-content:space-between;gap:12px;padding:5px 8px;border:0;border-radius:4px;background:transparent;color:var(--dsw-alias-label-primary,#1f2328);font:13px ui-monospace,SFMono-Regular,Menlo,Consolas,monospace;text-align:left;cursor:pointer}
.dsh-warp-terminal-completion-option:hover,.dsh-warp-terminal-completion-option.is-selected{background:rgba(65,118,230,.18)}
...
body[data-ds-dark-theme] .dsh-warp-terminal-banner{border-color:rgba(248,113,113,.35);background:rgba(248,113,113,.08)}
body[data-ds-dark-theme] .dsh-warp-terminal-banner.is-reconnecting{border-color:rgba(229,192,123,.35);background:rgba(229,192,123,.08)}
body[data-ds-dark-theme] .dsh-warp-terminal-error{color:#f87171}
body[data-ds-dark-theme] .dsh-warp-terminal-reconnecting{color:#e5c07b}
body[data-ds-dark-theme] .dsh-warp-seg-version{color:#98c379}
body[data-ds-dark-theme] .dsh-warp-seg-cwd{color:#61afef}
body[data-ds-dark-theme] .dsh-warp-seg-branch{color:#c678dd}
body[data-ds-dark-theme] .dsh-warp-seg-files{color:#e5c07b}
body[data-ds-dark-theme] .dsh-warp-seg-adds{color:#98c379}
body[data-ds-dark-theme] .dsh-warp-seg-dels{color:#e06c75}
body[data-ds-dark-theme] .dsh-warp-terminal-iconbtn:hover{background:rgba(255,255,255,.08)}
body[data-ds-dark-theme] .dsh-warp-terminal-iconbtn-kill{color:#f87171}
body[data-ds-dark-theme] .dsh-warp-terminal-iconbtn-kill:hover{background:rgba(248,113,113,.15);color:#fca5a5}
