...
.dsh-git-graph-filter-group{padding:8px 8px 2px;font-size:12px;line-height:16px;color:var(--dsw-alias-label-tertiary)}
.dsh-git-graph-filter-item{display:flex;align-items:center;gap:8px;width:100%;min-height:28px;padding:4px 8px;border:none;border-radius:10px;background:transparent;color:var(--dsw-alias-label-primary);font:inherit;font-size:14px;line-height:22px;text-align:left;cursor:pointer}
...
.dsh-git-graph-status{padding:16px 12px;font-size:13px;line-height:20px;color:var(--dsw-alias-label-secondary,#b0b0b5)}
...
.dsh-git-graph-sha,.dsh-git-graph-date,.dsh-git-graph-author{min-width:0;align-self:center;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:16px;color:var(--dsw-alias-label-tertiary,#8b8b90)}
...
.dsh-git-graph-detail-section-action{flex:none;display:inline-flex;align-items:center;justify-content:center;width:24px;height:24px;border:none;border-radius:6px;background:transparent;color:var(--dsw-alias-label-secondary,#b0b0b5);cursor:pointer}
...
.dsh-git-changes-toolbar{display:flex;align-items:center;gap:6px;margin-top:6px}
.dsh-git-changes-spacer{flex:1}
.dsh-git-changes-icon{flex:none;display:inline-flex;align-items:center;justify-content:center;width:28px;height:28px;border:none;border-radius:999px;background:transparent;color:var(--dsw-alias-label-secondary,#b0b0b5);cursor:pointer}
...
export function ensureGitGraphStyles(): void {
  injectStyles('@just-genius/dsh-codex', '@just-genius/dsh-codex/git-graph/styles.css', GRAPH_CSS)
}
