...
export const zh: Record<SyncKey, string> = {
  nav: '同步',
  title: '同步',
  hint: '用 GitHub 账号登录后，把 settings.yaml 与 web 插件清单同步到私有 Gist，无需自建服务器。',
  groupAccount: '账号',
  groupSync: '同步',
  groupStatus: '状态',
  ...
  pulledSettings: '已写入 settings.yaml',
  ...
  progressDone: '完成',
  conflictTitle: '检测到冲突',
  conflictBody: '本地与云端自上次同步后都有改动。强制拉取会覆盖本机 settings.yaml 与插件清单。',
  copyCode: '复制设备码',
  copied: '已复制',
  detailSep: '，',
  listSep: '、',
...
export const en: Record<SyncKey, string> = {
  nav: 'Sync',
  title: 'Sync',
  hint: 'Sign in with GitHub and sync settings.yaml plus the web plugin list to a secret Gist — no self-hosted sync server.',
  ...
  pulledSettings: 'Wrote settings.yaml',
  ...
  conflictBody: 'Both local and cloud changed since the last sync. Force pull overwrites settings.yaml and the plugin list.',
