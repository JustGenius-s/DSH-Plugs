...
import type {
  ClientContext, SettingsNamespaceView,
...
import type { SettingsDescribeFace } from '@just-genius/dsh-plugin-runtime/client'
import type { CredentialInfo } from './operations.ts'
import { remoteOf } from './operations.ts'
...
export class ModelsSettingsStore {
  ...
  /**
   * @param ctx - apply context whose `remote.llm` / `remote.credentials` carry directory and credential reads.
  ...
  async load(): Promise<void> {
    ...
    const remote = remoteOf(this.ctx)
