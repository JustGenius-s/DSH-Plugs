...
import { SCAN_PATH, folderName, normalizePrimaryPath, samePath, type AdoptResult, type RepoFolder } from '../shared.ts'
import { getPicker, subscribePicker } from './flow.ts'
import { postJson } from './http.ts'
import type { WorkspacePlusKey } from './locales.ts'
import styles from './BindingDialog.module.css'

export interface BindingDialogInjected {
  t: (key: WorkspacePlusKey) => string
  /** The ORIGINAL (unpatched) host folder picker — opens Finder / OS chooser. */
  pickDirectory: () => Promise<string | null>
}

export function BindingDialog({ t, pickDirectory }: Partial<BindingDialogInjected>) {
